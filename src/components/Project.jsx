...
export default function Project({ id, title, desc, technos, link }) {
	return (
		<a href={link} class=" transition ease-in-out duration-300 border-2 border-marron/50 flex rounded-2xl m-5 overflow-hidden bg-creme dark:bg-noir z-10 hover:bg-opacity-40 dark:hover:bg-opacity-40 hover:scale-95 hover:border-creme">
