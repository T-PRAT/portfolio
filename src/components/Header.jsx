	...
	return (
		<>
			<nav className='flex items-center justify-between w-full p-3 px-20'>
				<h2 className='p-2 font-bold text-xl rounded-full hover:ring-2 hover:ring-vert-500 active:bg-vert-200 dark:hover:ring-gris-100 dark:active:bg-gris-300'><Link to="/">tprat.fr</Link></h2>
